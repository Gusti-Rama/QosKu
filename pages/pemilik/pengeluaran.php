                            ...
                            <div class="card-body">
                                ...
                                <form method="POST">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="jenisPengeluaran" name="jenisPengeluaran"
                                            required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="namaPengeluaran"
                                            name="namaPengeluaran" required>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <div class="card bg-primary text-white border-0 rounded-3">
                                            <div class="card-body text-center">
                                                ...
                                                <h4 class="fw-bold mb-0">
                                                    Rp<?= number_format($grandTotal, 0, ',', '.') ?></h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            <?php foreach ($expenses as $expense): ?>
                                                <tr>
                                                    ...
                                                    <td><?= !empty($expense['keterangan']) ? htmlspecialchars($expense['keterangan']) : '-' ?>
                                                    </td>
                                                    <td>
