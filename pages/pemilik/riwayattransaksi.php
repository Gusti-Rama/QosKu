                                        ...
                                        <table class="table table-hover align-middle rounded-4 shadow-sm bg-white">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-<?= 
                                                            $order['statusPemesanan'] === 'Terkonfirmasi' ? 'success' : 
                                                            ($order['statusPemesanan'] === 'Tertunda' ? 'warning text-dark' : 'danger')
                                                        ?>">
                                        ...
                                        <table class="table table-hover align-middle rounded-4 shadow-sm bg-white">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-<?= 
                                                            $payment['statusPembayaran'] === 'Lunas' ? 'success' : 
                                                            ($payment['statusPembayaran'] === 'Menunggu Konfirmasi' ? 'warning text-dark' : 'secondary')
                                                        ?>">
